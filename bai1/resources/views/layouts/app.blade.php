        ...
        <div class="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 pb-4">
            ...
            <nav class="flex flex-1 flex-col">
                <ul role="list" class="flex flex-1 flex-col gap-y-7">
                    ...
                    <li>
                        <a href="/books"
                            class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold @if(Request::is('books')) bg-indigo-600 text-white @else text-gray-700 hover:bg-gray-50 hover:text-indigo-600 @endif">
                            <svg class="size-6 shrink-0 @if(Request::is('books')) text-white @else text-indigo-600 @endif"
                    ...
                    <li>
                        <a href="/readers"
                            class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold @if(Request::is('readers')) bg-indigo-600 text-white @else text-gray-700 hover:bg-gray-50 hover:text-indigo-600 @endif">
                            <svg class="size-6 shrink-0 @if(Request::is('readers')) text-white @else text-indigo-600 @endif"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                aria-hidden="true" data-slot="icon">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <a href="/borrows"
                            class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold @if(Request::is('borrows')) bg-indigo-600 text-white @else text-gray-700 hover:bg-gray-50 hover:text-indigo-600 @endif">
                            <svg class="size-6 shrink-0 @if(Request::is('borrows')) text-white @else text-indigo-600 @endif"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                aria-hidden="true" data-slot="icon">
                                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div
                ...
                <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                    ...
                    <div class="flex items-center gap-x-4 lg:gap-x-6">
                        ...
                        <!-- Profile dropdown -->
                        <div class="relative">
                            <button id="user-menu-button" type="button" class="-m-1.5 flex items-center p-1.5"
