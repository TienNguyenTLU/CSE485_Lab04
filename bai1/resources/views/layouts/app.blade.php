...
<html lang="vi">
    ...
    <body>
        <div id="menu" class="relative z-50 lg:hidden hidden" role="dialog" aria-modal="true">
                ...
                <div class="relative mr-16 flex w-full max-w-xs flex-1">
                    ...
                    <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                        <div class="flex h-16 shrink-0 items-center">
                            <span class="text-lg font-semibold text-gray-800">Library Management</span>
                        </div>
        ...
        <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
            ...
            <div class="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 pb-4">
                <div class="flex h-16 shrink-0 items-center">
                    <span class="text-lg font-semibold text-gray-800">Quản lý thư viện</span>
                </div>
                <nav class="flex flex-1 flex-col">
                    <ul role="list" class="flex flex-1 flex-col gap-y-7">
                        <!-- Menu Item Quản lý sách -->
                        <li>
                            <a href="/books" class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold @if(Request::is('books')) bg-indigo-600 text-white @else text-gray-700 hover:bg-gray-50 hover:text-indigo-600 @endif">
                                <svg class="size-6 shrink-0 @if(Request::is('books')) text-white @else text-indigo-600 @endif" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
                                    <path
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                        d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25"
                        ...
                        <!-- Menu Item Quản lý độc giả -->
                        <li>
                            <a href="/readers" class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold @if(Request::is('readers')) bg-indigo-600 text-white @else text-gray-700 hover:bg-gray-50 hover:text-indigo-600 @endif">
                                <svg class="size-6 shrink-0 @if(Request::is('readers')) text-white @else text-indigo-600 @endif" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
                                    <path
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                        ...
                        <!-- Menu Item Quản lý mượn -->
                        <li>
                            <a href="/borrows" class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold @if(Request::is('borrows')) bg-indigo-600 text-white @else text-gray-700 hover:bg-gray-50 hover:text-indigo-600 @endif">
                                <svg class="size-6 shrink-0 @if(Request::is('borrows')) text-white @else text-indigo-600 @endif" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
                                    <path
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
        ...
        <div class="lg:pl-72">
            <div class="sticky top-0 z-40 px-6">
                <div class="flex h-16 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-0 lg:shadow-none">
                    <button id="menu-button" type="button" class="-m-2.5 p-2.5 text-gray-700 lg:hidden">
                    ...
                    <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                        ...
                        <div class="flex items-center gap-x-4 lg:gap-x-6">
                            ...
                            <!-- Profile dropdown -->
                            <div class="relative">
                                <button id="user-menu-button" type="button" class="-m-1.5 flex items-center p-1.5" aria-expanded="false" aria-haspopup="true">
